...
Vidu 2 视频生成大模型，平衡速度与质量，主攻图生视频、首尾帧功能，支持 4 秒时长下 720P分辨率输出。生成速度大幅提升，成本显著降低；图生视频修复变色问题，画面稳定可控适配电商等场景，首尾帧语义理解与多参考图一致性增强，成为泛娱乐、互联网、动漫短剧、广告量产的高效工具。
...
## <Icon icon="arrow-down-big-small" iconType="solid" color="#134CFF" size={28} />  能力说明
