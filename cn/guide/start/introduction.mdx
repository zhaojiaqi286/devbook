...
<CardGroup cols={2}>
  <Card title="查看模型接口文档" icon="book-open" href="/cn/guide/models">
    了解各种模型的详细API文档和使用方法
  </Card>
  <Card title="体验中心" icon="flask" href="/experience">
    在体验中心直接体验模型能力
  </Card>
  <Card title="API Key 管理" icon="key" href="/api-keys">
    查看和管理您的 API Key
  </Card>
  <Card title="应用中心" icon="rocket" href="/applications">
    在应用中心创建和管理您的应用
  </Card>
</CardGroup>
